...
insert into transactions (transaction_id, transaction_datetime, transaction_type, transaction_status, payment_id) values (1, '2026-03-01 10:00:00', 'payment', 'completed', 1);
insert into transactions (transaction_id, transaction_datetime, transaction_type, transaction_status, payment_id) values (2, '2026-04-02 14:30:00', 'payment', 'pending', 2);
insert into transactions (transaction_id, transaction_datetime, transaction_type, transaction_status, payment_id) values (3, '2026-01-03 09:15:00', 'refund', 'failed', 3);
